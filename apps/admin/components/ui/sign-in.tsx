...
export const SignInPage: React.FC<SignInPageProps> = ({
  ...
  return (
    <div className="flex h-[100dvh] w-full flex-col overflow-hidden bg-white font-sans text-neutral-950 md:flex-row">
        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              <div className="animate-element animate-delay-500 flex items-center justify-between text-sm">
                <label className="flex cursor-pointer items-center gap-3">
                  ...
                  <span className="text-foreground/90">Manter conectada</span>
                </label>
                <a
                  href="#"
                  onClick={(event) => {
              ...
              <button
                type="submit"
                disabled={busy}
                className="animate-element animate-delay-600 w-full rounded-2xl bg-neutral-950 py-4 font-medium text-white transition-colors hover:bg-neutral-800 disabled:opacity-60"
              >
                {busy ? 'Aguarde…' : 'Entrar'}
              </button>
            </form>
            ...
            <div className="animate-element animate-delay-700 relative flex items-center justify-center">
              ...
              <span className="absolute bg-white px-4 text-sm text-muted-foreground">
                Ou continue com
              </span>
            </div>
            ...
            <button
              ...
              className="animate-element animate-delay-800 flex w-full items-center justify-center gap-3 rounded-2xl border border-border py-4 transition-colors hover:bg-secondary disabled:opacity-60"
            >
              <GoogleIcon />
            ...
            <p className="animate-element animate-delay-900 text-center text-sm text-muted-foreground">
              Nova por aqui?{' '}
              <Link href="/cadastro" className="text-violet-400 transition-colors hover:underline">
                Criar conta
              </Link>
            </p>
          </div>
      ...
      {heroImageSrc ? (
        <section className="relative hidden flex-1 p-4 md:block">
          ...
          {testimonials.length > 0 ? (
            <div className="absolute bottom-8 left-1/2 flex w-full justify-center gap-4 px-8 -translate-x-1/2">
